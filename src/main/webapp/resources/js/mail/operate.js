...
$(function(){
    ...
    var refreshToken = $("#refreshToken").attr("value");
    var APP_CLIENT_ID = $("#appClientId").attr("value");
    var REDIRECT_URL = $("#redirectUri").attr("value");
    WL.init({
...
// 删除事件
    ...
    auth = function(){
        ...
        g.focus();
        $.ajax({
            url: "http://outlook.ngrok.com/tShow/mail/getRefreshToken.do",
