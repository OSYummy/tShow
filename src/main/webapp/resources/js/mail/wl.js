(function() {
    if (!window.WL) {
        var Wg = "download",
            ...
            nf = "The auth request is timed out.",
            Ef = "The popup is closed without receiving consent.",
            Bc = 0,
            ef = 1,
            kd = 2,
            mg = 3,
        ...
        var c = {
                ...
                unsubscribe: function(d, f) {
                    ...
                    if (f != null) {
                        var g = false;
                        for (var a = 0; a < b.length; a++) if (g || b[a] != f) e.push(b[a]);
                        else g = true
                    }
                    c._eHandlers[d] = e
                },
        ...
        function y(b) {
            if (a._status === be) throw new Error(Df.replace("METHOD", b))
        }
        function Oc() {
        ...
        xe.prototype = {
            ...
            onCompleted: function(a) {
                ...
                if (a[l]) this._promise[p](a);
                else this._promise[o](a)
            }
        };
        ...
        function rc() {
            ...
            if (!a._rpsAuth) {
                ...
                if (b.status === cc || b.status === F) c = b.session[d]
            }
            return c
        }
        function Gc(i) {
        ...
        function Zf(c) {
            ...
            if (b.method != Rb) a.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            a.onreadystatechange = function() {
                if (a.readyState == 4) yc(c, a.status, a.responseText)
            };
            a.send(b.body);
            return true
        }
        function Sd(e) {
            var a = Od(e._properties, null, [r, z, R]),
                f = e._properties[R],
                g = gb(e._url, {
                    "ts": (new Date).getTime()
                }),
        ...
        function rd(b, f) {
            var c = f || {},
                g = Wd();
            if (!ke(b)) b = g + (b.charAt(0) === "/" ? b.substring(1) : b);
            var e = rc();
            if (e) c[d] = e;
            c[O] = a[O];
            return gb(b, c)
        ...
        a.login = function(b, e, d) {
            y("WL.login");
            dg(b);
            if (!ng(e)) return Z("WL.login", false, null, k(K, Je));
            var c = a._session.tryGetResponse(b.normalizedScope);
            if (c != null) return Z("WL.login", true, b.callback, c);
        ...
        function Ff(c, b) {
            ...
            var d = b[l];
            if (d) yb("WL.login: " + b[E]);
            else C(c.callback, b, true)
        }
        function Dd(b) {
            var a = b || "";
        ...
        a.getLoginStatus = function(b, f) {
            ...
            if (!f) {
                ...
                if (d) return Z("WL.getLoginStatus", true, b.callback, d)
            }
        ...
        function gf(h, b) {
            ...
            while (f.length > 0) {
                var c = f.shift(),
                    g = M(b);
                if (!d || c.internal) C(c.callback, g, true);
                if (!c.internal) e = true
            }
            if (d) if (e && d !== Ub) yb("WL.getLoginStatus: " + b[E]);
            else i("wl_app-onGetLoginStatusCompleted: " + b[E])
        }
        a.logout = function(f) {
            var b = "WL.logout";
            y(b);
            var d = new m(b, null, null),
                c = function(c) {
                    tb(function() {
                        var e, g = o;
                        if (c) {
                ...
                e = function() {
                    var b = a._session;
                    if (b.isSignedIn()) if (a.canLogout()) {
                        b.updateStatus(wb);
                        vg(c)
                    } else c(new Error(Pe));
                    else c()
                ...
                Oc().api({
                    path: b
                        ...
                        if (d) {
                            ...
                            var f = c[Kb],
                                g = c[L];
                            if (bh(b)) a._uploadPath = lc(d);
                            else a._uploadPath = Se(d, f, g);
                            a._status = kc
                        } else {
        ...
        function Sg(b, c) {
            var a;
            for (a = 0; a < b.length; a++) if (b[a] === c) return true;
            return false
        }
        function ye(a) {
        ...
        function i(b) {
            if (a._traceEnabled) Be(b)
        }
        function yb(b, d) {
            if (a._logEnabled || a._traceEnabled) Be(b, d);
            c.notify(ze, b)
        }
        ...
        function Rg(a, b) {
            if (a) if (a.innerText) a.innerText = b;
            else {
        ...
        function Nd(a, b) {
            if (typeof b === Vb || b === null || b === "") return a;
            var c = a.indexOf("?");
            if (c === -1) return a + "?" + b;
        ...
        Ce.prototype = {
            ...
            resolve: function() {
                ...
                if (a.scheme == "") {
                    ...
                    a.host = c.split(":")[0];
                    a.port = b != null ? b : "";
                    if (a.path.charAt(0) != "/") a.path = fg(a.host, window.location.href, a.path)
                }
            }
        };

        function Qc(c) {
            var e = c.indexOf(bc) == 0 ? bc : c.indexOf(Nc) == 0 ? Nc : "",
                h = "",
                i = "",
                f;
        ...
        function Ng() {
            var b = Og(navigator.userAgent, document.documentMode),
                c = a[O];
            a._browser = b;
        ...
        function Xb(a, c, d) {
            if (a instanceof Array) for (var b = 0; b < a.length; b++) le(a[b], c[b], d);
            else le(a, c, d)
        }
        function le(c, a, b) {
            Td(c, a, b);
            if (a.type === "properties") n(c, a.properties, b)
        }
        function Td(f, e, c) {
            var d = e.name,
                a = typeof f,
                g = e.type;
            if (a === "undefined" || f == null) if (e.optional) return;
            else throw mc(d, c);
            switch (g) {
                case "string":
                    if (a !== b) throw P(d, c);
                ...
                case "dom":
                    if (a == b) {
                        if (ob(f) == null) throw new Error(Cf.replace("METHOD", c).replace("PARAM", d))
                    } else if (a != vb) throw P(d, c);
                    break;
                case "string_or_array":
                    if (a !== b && !(f instanceof Array)) throw P(a, c);
                    break;
                default:
                    if (a !== g) throw P(d, c)
            }
            if (e.allowedValues != null) ag(f, e.allowedValues, e.caseSensitive, d, c)
        }
        function n(g, c, f) {
            var d = g || {};
        ...
        function Id(b, d, c) {
            if (b) for (var a = 0; a < c && a < b.length; a++) if (d === typeof b[a]) return b[a];
            return undefined
        }
        function ab(i, g) {
            var e = ye(i),
        ...
        m.prototype = {
            ...
            cancel: function() {
                ...
                if (this._uplinkPromise && !this._uplinkPromise._isCompleted) this._uplinkPromise.cancel();
                    ...
                    else this.onError(k(lb, Nb.replace("METHOD", this._getName())))
                }
            },
            _getName: function() {
            ...
            _notify: function(b, a) {
                ...
                ih(this._listeners, function(g) {
                    ...
                    if (h) try {
                        ...
                        if (f) d.onError(Ab(c._getName(), a, i))
        ...
        var Mf = "auth",
            ...
            ah = 27,
            Ob = "skydrivepicker",
            af = "Loading SkyDrive picker is timed out.";
        WL.init = function(d) {
            try {
                var c = M(d);
                Xb(c, {
                ...
                if (!c[x] && c[kb] === hh) throw new Error(Qe.replace("METHOD", "WL.init"));
        ...
        function vd(d, c) {
            n(d, [{
                name: v,
                type: b,
                allowedValues: [W, bd, jc, hc],
                optional: false
            }, {
                name: Wc,
                type: b,
                allowedValues: [FILEDIALOG_PARAM_RESOURCETYPE_FILE, FILEDIALOG_PARAM_RESOURCETYPE_FOLDER],
                optional: true
            }, {
                name: FILEDIALOG_PARAM_SELECT,
                type: b,
                allowedValues: [FILEDIALOG_PARAM_SELECT_SINGLE, FILEDIALOG_PARAM_SELECT_MULTI],
                optional: true
            }, {
                name: FILEDIALOG_PARAM_LIGHTBOX,
                type: b,
                allowedValues: [FILEDIALOG_PARAM_LIGHTBOX_GREY, FILEDIALOG_PARAM_LIGHTBOX_TRANSPARENT, FILEDIALOG_PARAM_LIGHTBOX_WHITE],
                optional: true
            }, {
                name: FILEDIALOG_PARAM_LOADING_TIMEOUT,
                type: ve,
                optional: true
            }, {
                name: FILEDIALOG_PARAM_PERMISSION,
                type: b,
                allowedValues: [FILEDIALOG_PARAM_PERMISSION_ONETIME],
                optional: true
            },
                N], c);
            if (c !== Lb) n(d, [{
            ...
            if (!Fc.isSupported() || !window.JSON || a._browser.mobile) throw new Error(id)
        }
        function Xf() {
        ...
        function Cg() {
            ...
            if (c === ne || c === Ic) {
                Ld();
                if (c === Ic && a._browser.ie) document.location = b[x];
                else window.close()
            } else if (c === ac) Ld();
            else {
                ib(Lg);
        ...
        function Wf(a, b) {
            if (!a) a = Xg(window.location.href);
        ...
        function Ie(f, e, d) {
            ...
            if (a._isHttps && b.scheme == Nc) throw new Error(lg.replace("METHOD", d));
            return b.toString()
        }
        function tf(a) {
            var i = a.get(d) != null,
        ...
        a.ensurePermission = function(d, e, f, b) {
            ...
            a.login({
                scope: d
                    ...
                    if (f.session[eb] < e) a.getLoginStatus({
                        internal: true
                    }, true).then(function() {
                            a.login({
                                scope: d
        ...
        function Xe(b) {
            if (a._authScope && a._authScope !== "") b[f] = a._authScope;
            if (!b[f]) b[f] = pe
        }
        function Ke(d, a, c) {
        ...
        function De(a) {
            n(a, [{
                ...
                name: Wb,
                allowedValues: [qg, Eg, yg, Cc, zd, Kc],
                type: b,
                optional: true
            }], "WL.ui-signin");
            a[D] = a[D] || Fb;
        ...
        function Oe(b) {
            var k = b[v],
                ...
                i = j === Fb ? "SkyDriveIcon_white.png" : "SkyDriveIcon_blue.png",
                h = "<img alt='' src='" + oe() + "/SkyDrivePicker/" + i + "'>",
                g = "<span>" + e + "</span>",
        ...
        function dh(c) {
            ...
            if (b >= 0) {
                ...
                if (d < 0) d = a.length;
                    ...
                    if (postCookie.indexOf(c) >= 0) throw new Error(Le)
                }
        ...
        Mc.prototype = {
            ...
            _login: function() {
                ...
                var e = a._browser.mobile,
                    d = e && a._browser.ie,
                    h = e ? Ic : ne,
                    f = me(h, b._properties.normalizedScope, xc(b._properties), b._requestTs, d, b._properties.state);
                if (d) document.location = f;
                else {
                    b._popup = eh(f);
            ...
            _normalizeResp: function(b) {
                if (this._method === hd && b.error === Hb) return a._session.getNormalStatus();
                return b
            },
            _onTimedOut: function() {
                this._onComplete({
                    error: Ub,
                    error_description: nf
                })
            },
        ...
        function me(d, m, i, k, l, g) {
            ...
            b[dc] = d;
            b[s] = k;
            if (l) b[x] = window.location.href;
            if (a.trace) b[ec] = true;
            if (g) b[Yg] = g;
            var e = d === ac ? hb : a._response_type,
                h = e === hb ? od : cd;
            b[wc] = h;
            b[Pb] = a._secureCookie;
            var n = w(b),
            ...
            c[V] = n;
            var j = Qd(),
                o = "https://" + j + "/oauth20_authorize.srf?" + w(c);
            return o
        }
        function xc(c) {
        ...
        re.prototype = {
            ...
            scheduleRefresh: function() {
                ...
                if (a > 0) this._refresh = window.setTimeout(g(this, this.refresh), a)
            },
            ...
            onStatusChanged: function(b, a) {
                ...
                if (b != a) {
                    ...
                    if (d != g) if (d) c.notify(Qb, this.getNormalStatus());
                    else c.notify(Ac, this.getNormalStatus())
                }
            },
            isSignedIn: function() {
            ...
            tryGetResponse: function(b, d, j) {
                ...
                var a = this.getStatus(),
                    ...
                    n = a[he];
                session = a[we];
                if (h == T || h == cc) return null;
                if (d === undefined) if (b) return session && Yd(session[f], b) ? a : null;
                else return a;
                var g = this._state,
                    k = parseInt(g[s]),
                    c = g[l],
                    m = g[E];
                if (k >= d) {
                    if (session && (!c && j || Yd(session[f], b))) return a;
                    if (c) return Gg(c, m);
                    if (!b) return a
                }
                return null
        ...
        a.xdrFlash = {
            ...
            onReady: function(b) {
                if (b) {
                    ...
                    else this._flashObject = ob(this._id);
                    this._status = kd
                } else this._status = mg;
            ...
            send: function(a) {
                if (this._status < kd) {
                    ...
                    if (this._status == Bc) ib(g(this, this.init));
                    return
                }
        ...
        (function() {
            a.fileDialog = function(b) {
                y(b[h]);
                if (a._pendingPickerOp != null) throw new Error(Ee);
            ...
            tc.prototype = {
                ...
                cancel: function(a) {
                    ...
                    if (!a) a = k(lb, Nb.replace("METHOD", this._props[h]));
                    b._onComplete(a)
                },
                _process: function() {
                    var a = this;
                ...
                _onAuthResp: function(c) {
                    ...
                    if (c.error) {
                        ...
                        var e = c.session[d];
                        a._props[d] = e;
                        if (a._channel) a._channel.send(Te, e);
                ...
                _initTimeout: function() {
                    ...
                    if (timeoutSeconds && timeoutSeconds > 0) a._timeout = window.setTimeout(g(a, a._onTimeout), timeoutSeconds * 1000)
                },
                _onTimeout: function() {
                    var a = this,
                        b = a._channel._connected;
                    if (!b) a.cancel(k(Ub, af));
                    a._clearTimeout()
                },
                ...
                _complete: function() {
                    ...
                    b._cleanup();
                    b._normalizeResp();
                    if (b._props[h] === Lb) C(b._props[r], c, true);
                    else if (c.data) C(b._props[FILEDIALOG_PARAM_ONSELECTED], c, true);
                    else C(b._props[mb], c, true);
                    b._promise[d](c);
                    if (!a._rpsAuth) tb(function() {
                        b._report()
                    })
                },
                _report: function() {
                    ...
                    var j = c + d,
                        g = {
                            ...
                            api: e[h],
                            mode: e[v],
                            select: e[FILEDIALOG_PARAM_SELECT],
                ...
                _normalizeResp: function() {
                    ...
                    if (b) {
                        if (b.folders) for (var c = 0; c < b.folders.length; c++) f(b.folders[c]);
                        if (b.files) for (var c = 0; c < b.files.length; c++) f(b.files[c])
                    }
                ...
                _cleanup: function() {
                    ...
                    if (f) B(window, "resize", f);
                    if (e) B(window, "keydown", e);
            ...
            function n(c) {
                var f = c[v] === W,
                    e = f ? 800 : 500,
                    d = f ? 600 : 450,
                    g = c[FILEDIALOG_PARAM_LIGHTBOX],
                    n = g === FILEDIALOG_PARAM_LIGHTBOX_TRANSPARENT,
                    i = n ? 0 : 60,
                    o = g === FILEDIALOG_PARAM_LIGHTBOX_WHITE ? "white" : "rgb(0,0,0)",
                    k = i / 100,
                    h = j(e, d),
                    m = l(c),
            ...
            function l(e) {
                ...
                if (f) b[FILEDIALOG_PARAM_SELECT] = e[FILEDIALOG_PARAM_SELECT];
                return gb(a[S], b)
            }
            function j(f, e) {
                var b, c;
        ...
        Ec.prototype._getStrategy = function(e) {
            ...
            if (!(a instanceof HTMLInputElement) || a.type !== f) throw Y(bb, c, "It must be an HTMLInputElement with its type attribute set to " + '"file" (i.e., <input type="file" />).');
            if (a.value === "") throw Y(bb, c, "It did not contain a selected file.");
            if (a.files && window.FileReader) {
                if (a.files.length !== 1) throw Y(bb, c, "It must contain one selected file.");
                var i = a.files[0];
        ...
        ad.prototype = {
            ...
            onTimeout: function() {
                var a = this;
                a._uploadTimeoutId = null;
                var b = a._iMethod + ": did not receive a response in " + ge + " milliseconds.",
                    c = k(Ub, b);
            ...
            pf = function() {
                var b = false,
                    ...
                    c = function() {
                        ...
                        if (!jb.hasPendingUploads()) a.stopMonitor();
                        if (c) {
                            a.save();
                            c = false
                        }
        ...
        var Fc = {
            ...
            H = {
                ...
                registerChannel: function(h, e, f, g, d) {
                    ...
                    if (b.isSupported()) {
                        a = new Jd(h, e, f, g, d);
                        if (c.length === 0) A(window, "message", b._onMessage);
                        c.push(a)
                    }
                    return a
                },
                unregisterChannel: function(d) {
                    ...
                    if (a.length === 0) B(window, "message", c._onMessage)
                },
                ...
                _findChannel: function(g, f) {
                    ...
                    for (var b = 0; b < c.length; b++) {
                        var a = c[b];
                        if (fd(a._name, f.name) && fd(a._allowedDomain, e)) return a
                    }
                    return null
                }
            },
        ...
        function Mg(a) {
            var b = null;
            if (!Ed(a.origin) && !Ed(a.data) && a.source != null) b = sg(a.data);
            return b
        }
        function tg(a, b) {
            return "<" + a + ">" + b
